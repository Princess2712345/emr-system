...
.logout-btn { color: #fca5a5; font-weight: 600; display: flex; align-items: center; gap: 10px; text-decoration: none; }
...
.p-name { color: #1e3a8a; font-size: 1.05rem; margin: 0; }
.p-reason { color: #64748b; margin: 4px 0 0; font-size: 0.9rem; }

.status-tag { padding: 0.4rem 0.8rem; border-radius: 8px; font-size: 0.75rem; text-transform: uppercase; letter-spacing: 0.5px; }
...
.action-btn { padding: 0.6rem 1rem; border-radius: 8px; font-weight: 700; cursor: pointer; transition: 0.2s; font-size: 0.85rem; }
...
.calendar-day { height: 120px; background: white; padding: 1rem; }
.day-num { font-weight: 700; color: #94a3b8; }
.event-indicator { background: #dbeafe; color: #1e3a8a; font-size: 0.75rem; font-weight: 700; padding: 4px 8px; border-radius: 6px; margin-top: 8px; text-align: center; }
...
.submit-btn { background: #2563eb; color: white; border: none; padding: 0.8rem 1.5rem; border-radius: 10px; font-weight: 700; cursor: pointer; width: 100%; margin-top: 1rem; }
.cancel-link { background: none; border: none; color: #64748b; cursor: pointer; font-weight: 600; float: right; margin-top: 1rem; }
</style>