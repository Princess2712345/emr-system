...
.logout-btn { color: #fca5a5; font-weight: 600; display: flex; align-items: center; gap: 10px; text-decoration: none; transition: 0.2s; }
.logout-btn:hover { color: #f87171; opacity: 0.8; }
