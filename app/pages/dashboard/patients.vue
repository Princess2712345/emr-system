      ...
      <section v-if="!selectedPatient" class="patient-body">
        ...
        <div class="table-container">
          <table class="patient-table">
            ...
            <tbody>
              <tr v-for="patient in filteredPatients" :key="patient.id" class="animate-row">
                <td>
...
/* Nuxt Active Link Style - matches both manual and auto active states */
.router-link-active, .nav-item.active { 
...
.patient-avatar { 
  ...
  font-weight: 800; font-size: 0.8rem; background: #dbeafe; color: #2563eb; 
}
...
.modal-content { background: white; width: 90%; max-width: 440px; border-radius: 16px; padding: 2rem; box-shadow: 0 20px 25px -5px rgba(0,0,0,0.1); }
